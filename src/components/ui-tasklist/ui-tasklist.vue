...
export default {
  ...
  methods: {
    ...
    insertTask: function (newValue, taskIdx, subtaskIdx, focus) {
      if (subtaskIdx === null) {
    ...
    removeTask: function (taskIdx, subtaskIdx) {
      if (subtaskIdx === null) {
    ...
    moveTask: function (taskIdx, subtaskIdx, into) {
    ...
    updateParentCheck: function (taskIdx) {
      let checkCount = 0
    ...
    updateChildChecks: function (taskIdx) {
      if (this.localValue[taskIdx].subtasks.length > 0) {
        for (let idx=0; idx<this.localValue[taskIdx].subtasks.length; idx++) {          
    ...
    focusTask: function(taskIdx, subtaskIdx) {
      if (subtaskIdx === null) {
    ...
    handleAdd: function (newValue, taskIdx) {
      this.insertTask(newValue, taskIdx + 1, null, true)
    },
    handleAppend: function (newValue, taskIdx) {
      let subtaskIdx = 0
    ...
    handleRemove: function (taskIdx, subtaskIdx) {
      if (subtaskIdx === null) {
    ...
    handleCheck: function (check, taskIdx, subtaskIdx) {
      if (subtaskIdx === null) {
    ...
    handleFocus: function (taskIdx, subtaskIdx) {
      this.focused = { task: taskIdx, subtask: subtaskIdx }
    },
    handleNextFocus: function (e) {
      e.preventDefault()
    ...
    handleDrag: function (taskIdx, subtaskIdx) {
      this.dragged = { task: taskIdx, subtask: subtaskIdx }
    },
    handleDrop: function (taskIdx, subtaskIdx) {
      this.moveTask(taskIdx, subtaskIdx)
    },
    handleDropInto: function (taskIdx, subtaskIdx) {
      this.moveTask(taskIdx, subtaskIdx, true)
    },
    handleUpdate: function (newValue, taskIdx, subtaskIdx) {
