...
export default {
  ...
  data: function() {
    return {
      focused: false,
      localChecked: (this.checked === 'true' || this.checked === true),
      draggable: false,
      drag: false,
      over: false,
      timer: 0,
  ...
  computed: {
    ...
    checkClass: {
      get: function () {
        ...
        if (this.localChecked === 'true' || this.localChecked === true) { output += ' --checked' }
    ...
    bodyClass: {
      get: function() {
        ...
        if (this.editable !== 'true' && this.editable !== true) { output += ' --no-edit' }
