...
export default {
  ...
  methods: {
    ...
    addFromInput: function(newValue, autofocus) {
      let val = newValue
    ...
    alreadyInList: function (label, val) {
      let output = false
    ...
    optionClass: function(result, idx) {
