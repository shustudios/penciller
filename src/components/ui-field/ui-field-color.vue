  ...
  computed: {
    localValue: {
      get: function () {
        ...
        if (this.isValidFormat(this.value, 'hex')) {
          output = this.value
        }
    ...
    swatchValue: function () {
      let output = '#FF0000'

      if (this.isValidFormat(this.localValue, 'hex')) {
